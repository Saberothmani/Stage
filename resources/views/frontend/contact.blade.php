        ...
        <div class="row mt">
         ...
         <div class="alert alert-success">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <p> Designet formation </p>
            <ul class="contact_details">
              <li><i class="fa fa-envelope-o"></i> https://designet-tn.com/</li>
              <li><i class="fa fa-phone-square"></i> +216 27 180 092</li>
              <li><i class="fa fa-home"></i> Rue de la revolution en face de Sonede 1er ertage Bureau2 manzet temime Nabeul 8080</li>
            </ul>
            <!-- contact_details -->
          </div>
        </div>
